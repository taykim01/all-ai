        ...
        <main className="container mx-auto px-4 py-20">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl md:text-6xl font-bold leading-tight">
              가장 <span className="gradient-text">적합한 GPT 모델</span>이<br />
              당신의 질문에 답합니다
            </h1>

            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              더 이상 어떤 AI를 선택할지 고민하지 마세요. All-AI가 질문의 특성을
              분석하여 GPT-4.1, o1, o3 등 최적의 GPT 모델을 자동으로
              선택합니다.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-20">
              <div className="space-y-4 p-6 rounded-xl bg-card border">
                ...
                <h3 className="text-lg font-semibold">지능형 GPT 모델 선택</h3>
                <p className="text-muted-foreground">
                  질문의 특성을 분석하여 코딩, 수학, 창작 등 각 분야에 가장
                  적합한 GPT 모델을 자동 선택
                </p>
              </div>
              ...
              <div className="space-y-4 p-6 rounded-xl bg-card border">
                ...
                <h3 className="text-lg font-semibold">최적화된 GPT 성능</h3>
                <p className="text-muted-foreground">
                  빠른 응답 속도와 높은 정확도를 위해 각 상황에 맞는 최적의 GPT
                  모델을 활용
                </p>
              </div>
            </div>
          ...
          <div className="text-center space-y-12">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center space-y-4">
                ...
                <h3 className="text-lg font-semibold">GPT 분석</h3>
                <p className="text-muted-foreground">
                  질문을 분석하여 최적의 GPT 모델을 선택
                </p>
              </div>
        ...
        <section className="container mx-auto px-4 py-20">
          <div className="text-center space-y-8 bg-primary/5 rounded-2xl p-12">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              어떤 AI 서비스를 구독할지 고민하지 마세요. All-AI 하나로 모든 GPT 모델의
              장점을 활용할 수 있습니다.
            </p>
            <Button
              size="lg"
